...
import com.food.schrood.databinding.ListProductStoreItemBinding
import com.food.schrood.model.CommonDataItem


class ProductStoreItemAdapter(
    mContext: Context,
    categoryList: MutableList<CommonDataItem>,
    val onItemClick: (position: Int, type: String) -> Unit
) :
    RecyclerView.Adapter<ProductStoreItemAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        val binding =
            ListProductStoreItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MainViewHolder(val binding: ListProductStoreItemBinding) :
